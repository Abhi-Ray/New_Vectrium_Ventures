...
export const Timeline = ({
  ...
  return (
    <div
      ...
      ref={containerRef}>
      <div className="h-[7rem] lg:h-[20rem] flex items-center justify-center pt-8">
      <TextHoverEffect text="VECTRIUM" />
      </div>
          ...
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div
              ...
              <div
                ...
                <div
                  className="h-4 w-4 rounded-full bg-neutral-800 dark:bg-neutral-800 border border-neutral-700 dark:border-neutral-700 p-2" />
              </div>
              <h3
