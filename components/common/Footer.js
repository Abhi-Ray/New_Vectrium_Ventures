...
const Footer = () => {
  ...
  useEffect(() => {
    ...
    const initSocialHover = (element, index) => {
      ...
      const handleMouseEnter = () => {
        element.style.transform =
          "perspective(1000px) rotateX(-15deg) rotateY(10deg) translateZ(30px) scale(1.2)";
    ...
    const initLinkHover = (element) => {
      ...
      const handleMouseEnter = () => {
        element.style.transform =
          "perspective(1000px) rotateX(-5deg) translateZ(10px) translateY(-2px)";
      ...
      const handleMouseLeave = () => {
        element.style.transform =
          "perspective(1000px) rotateX(0deg) translateZ(0px) translateY(0px)";
    ...
    const initLogoHover = (element) => {
      ...
      const handleMouseEnter = () => {
        setIsHovered(true);
        element.style.transform =
          "perspective(1000px) rotateX(-8deg) rotateY(8deg) translateZ(15px) scale(1.08)";
        element.style.transition =
          "all 0.6s cubic-bezier(0.175, 0.885, 0.32, 1.275)";
        element.style.filter =
          "brightness(1.3) drop-shadow(0 15px 30px rgba(255, 255, 255, 0.1))";
      };
    ...
    <footer
      ...
      style={{
        transform: `perspective(1000px) rotateX(${
          mousePosition.y * 2 - 1
        }deg) rotateY(${mousePosition.x * 2 - 1}deg)`,
      }}
    >
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div
            className="neural-network absolute top-1/3 right-1/3 w-1 h-1 bg-gray-400 rounded-full"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className="neural-network absolute bottom-1/4 left-1/3 w-1.5 h-1.5 bg-white rounded-full"
            style={{ animationDelay: "2s" }}
          ></div>
          <div
            className="neural-network absolute bottom-1/3 right-1/4 w-1 h-1 bg-gray-300 rounded-full"
        ...
        <div className="absolute inset-0 pointer-events-none">
          <Cpu
            className="floating-icon absolute top-1/4 right-1/4 w-6 h-6 text-gray-700 opacity-20"
            style={{ animationDelay: "0s" }}
          />
          <Bot
            className="floating-icon absolute bottom-1/3 left-1/5 w-5 h-5 text-gray-600 opacity-15"
            style={{ animationDelay: "2s" }}
          />
          <Zap
            className="floating-icon absolute top-1/2 left-1/6 w-4 h-4 text-gray-700 opacity-25"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-12">
          ...
          <div className="lg:col-span-6">
            ...
            <div className="space-y-6">
              ...
              >
                We blend innovation with simplicity—delivering real results
                through cutting-edge technology, human-centered design, and
            ...
            {socialLinks.map((social, index) => {
              ...
              return (
                ...
                >
                  <Icon
                    size={22}
                    className="text-gray-300 group-hover:text-white relative z-10 transition-colors duration-300"
                  />
