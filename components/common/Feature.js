...
const FeatureTitle = ({ children }) => {
  return (
    <p className="max-w-5xl mx-auto text-left tracking-tight text-black text-white text-xl md:text-2xl md:leading-snug">
      {children}
    </p>
  );
};
  ...
  return (
    <p
      className={cn(
        ...
        "text-neutral-500 font-normal text-neutral-300",
...
export const SkeletonOne = () => {
  return (
    <div className="relative flex py-8 px-2 gap-10 h-full">
      <div className="w-full p-5 mx-auto bg-black bg-neutral-900 shadow-2xl group h-full">
      ...
      <div className="absolute bottom-0 z-40 inset-x-0 h-60 bg-gradient-to-t f from-black  via-black to-transparent pointer-events-none" />
...
export const SkeletonThree = () => {
  return (
    ...
    >
      <div className="w-full mx-auto bg-transparent bg-transparent group h-full">
...
export const SkeletonTwo = () => {
  ...
  return (
    <div className="relative flex flex-col items-start p-8 gap-10 h-full overflow-hidden">
      ...
      <div className="absolute left-0 z-[100] inset-y-0 w-20 bg-gradient-to-r  from-black to-transparent pointer-events-none" />
      <div className="absolute right-0 z-[100] inset-y-0 w-20 bg-gradient-to-l  from-black to-transparent pointer-events-none" />
    </div>
  );
};
