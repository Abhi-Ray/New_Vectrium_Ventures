...
import { Menu, X, User, LogOut, Settings, BarChart3, Shield, CreditCard } from 'lucide-react';
  ...
  useEffect(() => {
    const initNavHover = (element, index) => {
      ...
      const handleMouseEnter = (e) => {
        ...
        element.style.background = 'linear-gradient(135deg, rgba(59, 130, 246, 0.05), rgba(147, 51, 234, 0.05))';
      };
...
>
  <User size={18} className="relative z-10" />
                  ...
                  >
                    ...
                    <div className="px-4 py-3 border-b border-gray-800/50">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-white" style={{ fontFamily: 'Geist Sans, system-ui, -apple-system, sans-serif' }}>
                            {session?.user?.name || 'User'}
                          </p>
                          <p className="text-xs text-gray-400 truncate max-w-[180px]" style={{ fontFamily: 'Geist Sans, system-ui, -apple-system, sans-serif' }}>
        ...
        <div className={`md:hidden fixed inset-x-0 top-16 z-50 transition-all duration-300 ease-out ${
          isMenuOpen 
          ...
          <div className="relative mx-4 mt-2">
            <div className="bg-black/95 backdrop-blur-xl rounded-2xl border border-gray-800/50 shadow-2xl overflow-hidden"
              style={{
                boxShadow: `
                  0 25px 50px -12px rgba(0, 0, 0, 0.8),
                  0 0 0 1px rgba(255, 255, 255, 0.05),
                ...
                {navLinks.map((link, index) => (
                  ...
                  >
                    <div className="flex items-center justify-between w-full">
                      <span className="text-base font-medium relative z-10">{link.name}</span>
                    ...
                    <div className="px-4 py-3 rounded-xl bg-gray-800/30 border border-gray-700/50">
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-medium text-white truncate" style={{ fontFamily: 'Geist Sans, system-ui, -apple-system, sans-serif' }}>
                            {session?.user?.name || 'User'}
                          </p>
                          <p className="text-xs text-gray-400 truncate" style={{ fontFamily: 'Geist Sans, system-ui, -apple-system, sans-serif' }}>
                            {session?.user?.email || 'No email'}
                          </p>
                        </div>
                      </div>
