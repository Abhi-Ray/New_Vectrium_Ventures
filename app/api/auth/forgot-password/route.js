...
export async function POST(request) {
  try {
    ...
    await transporter.sendMail({
      ...
      to: email,
      subject: 'Password Reset Request - Vectrium Ventures',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: linear-gradient(135deg, #0f0f0f 0%, #1f1f1f 100%); padding: 20px; border-radius: 10px; margin-bottom: 20px; text-align: center;">
            <h1 style="color: white; margin: 0;">Vectrium Ventures</h1>
            <p style="color: #ccc; font-size: 14px; margin: 5px 0 0;">Innovating with Intelligence</p>
          </div>
          
          <!-- Main Content -->
          <div style="background: #f8f9fa; padding: 30px; border-radius: 10px;">
            <p style="color: #333; font-size: 16px; margin-bottom: 20px;">You requested a password reset for your <strong>Vectrium Ventures</strong> account.</p>
