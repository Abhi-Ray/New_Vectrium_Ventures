    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-16 slide-in">
          ...
          <h1
            className="text-2xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-white via-gray-100 to-gray-300 bg-clip-text text-transparent"
            style={{
          ...
          <p
            className="text-gray-400 text-lg max-w-3xl mx-auto leading-relaxed mb-8"
            style={{
              fontFamily: "Geist Sans, system-ui, -apple-system, sans-serif",
            }}
          >
          ...
          <section id="introduction" className="slide-in">
            ...
            <div className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 rounded-2xl p-8 border border-gray-700/30 backdrop-blur-sm">
              <p className="text-gray-300 leading-relaxed mb-4">
                Welcome to Vectrium Ventures. We are committed to protecting
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                ...
                our Services, as well as any related services, sales, marketing
                or events.
              </p>
          ...
          <section id="data-sharing-and-disclosure" className="slide-in">
            ...
            <div className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 rounded-2xl p-8 border border-gray-700/30 backdrop-blur-sm">
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                following legal basis: Consent, Legitimate Interests,
                Performance of a Contract, Legal Obligations, Vital Interests.
              </p>
            </div>
          </section>
            ...
            <div className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 rounded-2xl p-8 border border-gray-700/30 backdrop-blur-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3 text-gray-300">
                    ...
                    <a
                      href="mailto:legal@vectriumventures.com"
                      className="hover:text-white transition-colors duration-300"
                    >
              ...
              <div className="bg-gradient-to-r from-blue-900/20 to-purple-900/20 rounded-xl p-6 border border-blue-700/30">
                ...
                <p className="text-gray-300 text-sm leading-relaxed">
                  ...
                  business days. For urgent matters related to service outages
                  or security concerns, please mark your email as "URGENT" in
                  the subject line.
                </p>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-r from-gray-800/50 to-gray-700/50 rounded-2xl p-12 border border-gray-600/30 backdrop-blur-sm">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <div className="text-gray-500 text-sm">We're here to help.</div>
              </div>
